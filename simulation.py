...
class Medium:
    def __init__(self, id, pathways, overhead, byte_rate, drop_rate):
        ...
        self.overhead = overhead # overhead for processing 1 packet
        self.byte_rate = byte_rate # current throughput capacity, this number is split across all active pathways
        ...
        self.buffer = [] # used by routing algorithms to store incoming packets (the size and required distribution of buffers will be a recorded metric for differing algorithms)
